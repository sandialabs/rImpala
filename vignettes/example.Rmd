...
# This vignette needs several suggested packages. Skip evaluation when any is
# missing so the package still checks without them installed.
.pkgs <- c("BASS", "mvBayes", "fdasrvf", "bayesplot")
.have_pkgs <- all(vapply(.pkgs, requireNamespace, logical(1), quietly = TRUE))
knitr::opts_chunk$set(eval = .have_pkgs)
```
